...
func main() {
	...
	case 14:
		fourteen.Run(uint8(partF), *exampleF)
	case 15:
		fifteen.Run(uint8(partF), *exampleF)
	case 16:
		sixteen.Run(uint8(partF), *exampleF)
	case 17:
		seventeen.Run(uint8(partF), *exampleF)
	case 18:
		eighteen.Run(uint8(partF), *exampleF)
	}
}
